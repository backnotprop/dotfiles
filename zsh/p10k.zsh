# Generated by Powerlevel10k configuration wizard on 2024-12-27 at 16:05 EST.
...
() {
  ...
  # Custom appearance for [ramos]
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=5
  # typeset -g POWERLEVEL9K_NODE_VERSION_CONTENT_EXPANSION='🍒 $P9K_CONTENT'
  typeset -g POWERLEVEL9K_NODE_VERSION_CONTENT_EXPANSION='${${VIRTUAL_ENV:+🐍 $(python --version | cut -d" " -f2)}:-🍒 $P9K_CONTENT}'
